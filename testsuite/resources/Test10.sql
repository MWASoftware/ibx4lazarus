SET SQL DIALECT 3;
SET AUTODDL ON;
-- SQL parse and extract test

CREATE DATABASE '\fbsql-test\employee.fdb' PAGE_SIZE 8192
...
TIMESTAMP BY DESCRIPTOR, INTEGER BY DESCRIPTOR
RETURNS TIMESTAMP BY DESCRIPTOR
...
TIMESTAMP BY DESCRIPTOR, INTEGER NULL,  CSTRING(10) CHARACTER SET NONE BY DESCRIPTOR,  CSTRING(10) CHARACTER SET NONE
...
',<array dim = "1" sqltype = "448" length = "60" relation_name = "JOB" column_name = "LANGUAGE_REQ" charset = "NONE" bounds="1:5">
 <elt ix="1">Japanese
</elt>
 <elt ix="2">Mandarin
</elt>
...
ALTER SEQUENCE FB$OUT_SEQ RESTART WITH 0;
SET Generator FB$OUT_SEQ to 1;
