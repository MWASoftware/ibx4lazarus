...
CREATE DATABASE 'inet://localhost//tmp/fbtestsuite.fdb' PAGE_SIZE 8192
...
(
	...
	FULL_NAME	VARCHAR(37) CHARACTER SET UTF8 COMPUTED BY (last_name || ', ' || first_name),
PRIMARY KEY (EMP_NO)
);
...
(
	...
	NEW_SALARY	DOUBLE PRECISION COMPUTED BY (old_salary + old_salary * percent_change / 100),
