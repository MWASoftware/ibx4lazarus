...
type
  ...
  public
    ...
    procedure Release(Dummy: PtrInt);
    procedure ReceiveMessage(Data: PtrInt);
  end;
...
procedure TIBCustomSQLMonitor.Release(Dummy: PtrInt);
begin
...
var
  st : TTraceObject;
begin
  //writeln('Monitor Window Proc Called');
...
begin
  ...
  Application.QueueAsyncCall(Monitor.Release,0)
end;
